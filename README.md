...
Die dreißig Spiele und der Bugreport liegen in eigenen Repos und werden
...
| Pfad | Was |
|---|---|
| `spiele/index.html` | Startseite mit den dreißig Spielkacheln, nach Kategorien gruppiert, Statuspunkten und dem Spendenknopf |
